...
import { Plus, AlertTriangle, CheckCircle, AlertCircle, Edit, Info, ArrowUp, ArrowDown, Tag, ChevronUp, ChevronDown } from 'lucide-react';
        ...
        <Table>
          <TableHeader className="bg-gray-50/50">
            <TableRow className="h-10 border-b border-gray-200">
              <TableHead className="py-2 px-3 text-sm font-medium text-gray-700">Material</TableHead>
              <TableHead className="py-2 px-3 text-sm font-medium text-gray-700">Threshold</TableHead>
              <TableHead className="py-2 px-3 text-sm font-medium text-gray-700 text-center">
              ...
              <TableHead className="py-2 px-3 text-sm font-medium text-gray-700">Status</TableHead>
              <TableHead className="py-2 px-3 text-sm font-medium text-gray-700">Actions</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {sortedMaterials.map((material) => {
              ...
              return (
                <TableRow key={material.id} className="h-12 border-b border-gray-100 hover:bg-gray-50/50">
                  ...
                  <TableCell className="py-2 px-3 text-sm font-semibold text-center text-gray-900">
